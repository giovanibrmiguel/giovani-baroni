...
The title comes from a fluid mechanics class Baroni took at university, where he became interested in the way invisible forces — currents, pressure, and movement — appear not only in physics, but in ordinary life. In the song, that image becomes a way to write about love as something innocent and transformative.`,
    links: {
      ...
      appleMusic: "https://music.apple.com/us/song/mec%C3%A2nica-dos-fluidos/6797999496",
      youtube: "https://www.youtube.com/watch?v=rf7LfiN4aCs&list=PLQOQ2QTpOP7yOP7fq-XYHADFOKVjLBr27&t=911s",
      deezer: "https://link.deezer.com/s/34pDoNMMABF9vwsv1tc3j",
      amazonMusic: "https://music.amazon.com.au/tracks/B0HCX2S6MS?marketplaceId=A39IBJ37TRP1C6&musicTerritory=AU&ref=dm_sh_cx1N3zO9JztDfzZmqtD9jKYcQ",
      youtubeMusic: "https://music.youtube.com/watch?v=o8tLe4u_V-c&si=f_DhhNSHhUd4vWxn",
    },
    featured: false,
  ...
  // ── Fishy Boy — Single ───────────────────────────────────────────────────
  {
    ...
    links: {
      ...
      appleMusic: "https://music.apple.com/us/song/fishy-boy/6797999499",
      deezer: "https://link.deezer.com/s/34pDzyXGI0kysgeGuxkXV",
      ...
      youtubeMusic: "https://music.youtube.com/watch?v=m0h-ojyjafU&si=RA5fZQHQOy9a-JiO",
    },
    featured: false,
    embedCode: `<iframe style="border-radius:12px" src="https://open.spotify.com/embed/track/PLACEHOLDER" width="100%" height="152" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>`,
    credits: [
  ...
  // ── Stop & Go Station ────────────────────────────────────────────────────
  {
    ...
    type: "ep",
    year: 2023,
    coverImage: "/images/projects/stop-and-go-cover.jpg",
    shortDescription:
...
[UPDATE: Replace with actual EP description]`,
  ...
  // ── Ruído Branco — Single ────────────────────────────────────────────────
  {
    ...
    type: "single",
    year: 2024,
    coverImage: "/images/projects/ruido-branco.jpg",
  ...
  // ── Sleep — Single ───────────────────────────────────────────────────────
  {
    ...
    type: "single",
    year: 2024,
    coverImage: "/images/projects/sleep.jpg",
  ...
  // ── sukya || porno — TALASSOFOBIA ────────────────────────────────────────
  {
    ...
    type: "ep",
    year: 2019,
    coverImage: "/images/projects/talassofobia.jpg",
    shortDescription:
...
[UPDATE: Replace with actual EP description]`,
  ...
  // ── sukya || porno — Quando a Urbe Vira Mangue e Nosso Sangue, Lama ─────
  {
    ...
    type: "ep",
    year: 2017,
    coverImage: "/images/projects/urbe.jpg",
    shortDescription:
